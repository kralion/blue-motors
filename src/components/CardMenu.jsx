...
export const CardMenu = ({ details, stars, price, image }) => {
  return (
    ...
    hover:cursor-pointer px-8 py-6 font-medium text-gray-800 w-fit flex items-center gap-x-10 border-b-[1px] border-gray-200">
      ...
      <div className="p-[5px]">
        <div className="details hover:text-red-dark ">
          {details}
        </div>
        <div className='relative '>
          ...
          {[...Array(stars)].map((_, index) => (
            <svg
              ...
              strokeWidth="1"
              stroke="currentColor"
              className="size-6 fill-yellow-400 stroke-yellow-400 "
            >
              <path
                strokeLinecap="round"
        ...
        <div className=' stars w-fit flex gap-x-1 justify-between'>
          <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
