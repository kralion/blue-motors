...
const MenuToggle = ({ toggle, isOpen }) => {
  ...
  return (
    <div onClick={toggle} style={{ cursor: 'pointer', width: '24px', height: '24px' }}>
      <motion.svg
...
const MenuItem = ({ label, children, route }) => {
  ...
  return (
    <div>
      <div
        className='box-border px-5 flex items-center relative h-[60px] border-b-gray-600 border-b-[1px] hover:text-red-dark hover:bg-gray-900 transition ease-in-out delay-100'
...
//   return (
//     <div className='h-[150px] ' onClick={toggle} style={{ cursor: 'pointer', width: '24px', height: '24px' }}>
//       <motion.svg
//         xmlns="http://www.w3.org/2000/svg"
//         viewBox="0 0 24 24"
//         width="30"
...
//               <div className='box-border px-5 w-full h-[60px] flex items-center bg-gray-700 border-b-gray-600 border-b-[.5px] hover:text-red-dark transition ease-in-out delay-150' >{child}</div>
...
//           }}
//           transition={{ duration: 0.3 }}
//           style={{ overflow: 'hidden', padding: '10px', borderBottomRightRadius: '5px',
//             borderBottomLeftRadius: '5px' }}
//         >
...
//       <MenuToggle 
//         className=' '
//       toggle={toggleMenu} isOpen={isOpen} />
//       <DropdownMenu 
