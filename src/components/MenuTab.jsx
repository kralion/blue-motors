                    ...
                    <TabPanel
                        ...
                        <div className='flex '>
                            <div className='flex flex-col'>
                                ...
                                <CardMenu details="Camp Kids Boots" price="580.00" image={tubo} stars={3} />
                                <CardMenu details="Box Plain Mat" price="154.00" image={casco} stars={4} />
                                <CardMenu details="Abdes Texxtile Jacket" price="402.00" image={chaqueta} stars={5} />
